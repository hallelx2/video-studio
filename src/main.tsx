...
const router = createHashRouter([
  ...
  },
  {
    ...
    children: [
      ...
      // Preview-first studio. The legacy chat-style Workbench has been
      // retired — its functionality is preserved inside DetailsModal
      // (chat / tools / logs) accessible via the ⋯ button in the
      // StageHeader.
      { path: "project/:productId", element: <StageRoute /> },
